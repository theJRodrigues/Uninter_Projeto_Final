...
import ProviderModal from "../../pages/register/components/ProviderModal";
  ...
  return (
    <>
      ...
      >
        ...
        <button
          type="submit"
          className="w-[100%] mt-2 m-auto px-2 py-1 rounded text-white cursor-pointer bg-green-600 hover:bg-green-700"
        >
          Cadastrar
        </button>
      </form>
      {showModal && <ProviderModal handleCloseModal={handleCloseModal} />}
    </>
  );
};
